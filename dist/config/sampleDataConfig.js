...
function getSampleData() {
    ...
    return {
        account: {
            ...
            description: 'Cliente demonstrativo criado automaticamente pelo provisionador de CS. ' +
            ...
            accountNotes: 'Cliente em fase de evolução. Adoção do sistema ocorreu com sucesso. ' +
        ...
        interaction: {
            ...
            description: 'Reunião periódica de acompanhamento com cliente para avaliar progresso, ' +
                'identificar desafios e planejar próximos passos.',
            interactionType: 'Reunião',
            interactionDate: today.toISOString().split('T')[0],
            interactionSummary: 'Cliente relatou excelente evolução na adoção da Plataforma Core. ' +
            ...
            sentiment: 'Positivo',
            collectedInsight: 'Equipe do cliente precisa de treinamento específico no Analytics. ' +
                'Há interesse em expandir para outros módulos após melhorar adoção atual. ' +
                'Conta será renovada conforme previsto.',
            nextSteps: '1. Agendar sessão de treinamento do Analytics para próx. 2 semanas\n' +
        ...
        successPlan: {
            ...
            description: 'Plano estruturado para aumentar a utilização do módulo Analytics ' +
                'de 20% para 80% em 90 dias.',
            actionObjective: 'Objetivo: Alcançar 80% de utilização semanal do Analytics em 90 dias.\n' +
                'Ações:\n' +
            ...
            successMetrics: 'Métrica de Sucesso: Número de relatórios gerados por semana.\n' +
        ...
        opportunity: {
            ...
            description: 'Oportunidade de expansão identificada durante acompanhamento. ' +
                'Cliente tem necessidade e capacidade de absorver Módulo de Integrações.',
            recordType: 'Expansão de Produto',
            estimatedValue: 3000,
            probability: 'Média',
            nextSteps: '1. Demonstração do módulo de Integrações (2 semanas)\n' +
        ...
        renewal: {
            ...
            description: 'Processo de renovação contratual para Cliente Exemplo - Empresa Alfa.\n' +
                'Data: ' +
                renewalDate.toISOString().split('T')[0] +
                '\n' +
                'Valor atual: R$ 96.000 (anual)',
            probability: 'Alta',
            nextSteps: '1. Revisão de saúde da conta e value delivered (Agosto 2026)\n' +
