...
function loadFiltersProvisionConfig() {
    const filters = [
        ...
        },
        {
            ...
            jqlTemplate: 'project = {projectKey} AND "Ciclo da Conta" = "Risco" ORDER BY updated DESC',
        },
        {
        ...
        },
        {
            ...
            jqlTemplate: 'project = {projectKey} AND issuetype = "Cliente" AND "Ciclo da Conta" = "Ativo"',
        },
        {
            key: 'churnedAccounts',
            name: 'CSM - Contas churnadas',
            description: 'Contas marcadas como churn.',
            jqlTemplate: 'project = {projectKey} AND issuetype = "Cliente" AND "Ciclo da Conta" = "Churn"',
        },
        {
