...
exports.loadDashboardsProvisionConfig = loadDashboardsProvisionConfig;
function loadDashboardsProvisionConfig() {
    const dashboards = [
        {
            key: 'health',
            name: 'CSM - Saúde da base',
            description: 'Visão geral da saúde da base de clientes com indicadores de risco, atividade e scores de saúde.',
            gadgets: [
                {
