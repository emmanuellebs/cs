...
export function loadFiltersProvisionConfig(): FiltersProvisionConfig {
  const filters: FilterConfig[] = [
    ...
    },
    {
      ...
      jqlTemplate:
        'project = {projectKey} AND "Status da conta" = "Risco" ORDER BY updated DESC',
    },
    {
    ...
    },
    {
      ...
      jqlTemplate:
        'project = {projectKey} AND issuetype = "Conta Cliente" AND updated <= -60d ORDER BY updated ASC',
    },
    {
      ...
      jqlTemplate:
        'project = {projectKey} AND issuetype = "Oportunidade CS" AND statusCategory != Done ORDER BY created DESC',
    },
    {
    ...
    },
    {
      ...
      jqlTemplate:
        'project = {projectKey} AND issuetype = "Conta Cliente" AND "Status da conta" = "Ativo"',
    },
    {
      key: 'churnedAccounts',
      ...
      jqlTemplate:
        'project = {projectKey} AND issuetype = "Conta Cliente" AND "Status da conta" = "Churn"',
    },
    {
